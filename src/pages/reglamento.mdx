# Reglamento de la Olimpiada Femenil Mexicana de Informática
...
- no deberán utilizar ninguna herramienta de inteligencia artificial para generar código (como Github Copilot, ChatGPT, entre otros).
