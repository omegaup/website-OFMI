...
export const Text = React.forwardRef<HTMLSpanElement, React.PropsWithChildren<TextProps>>(function Text (
  { twCss, children, className, ...props }: TextProps,
  ref: React.Ref<HTMLSpanElement>
) {
  return (
    <span ref={ref} className={twClassName(twCompose(defaultStyle, twCss), className)} {...props}>
      {children}
    </span>
  )
})
