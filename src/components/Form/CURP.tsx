...
export default function({ fullLast, fullFirst, birthday, state, ...others }: CURP) {
    const [ firstLastName, secondLastName ] = clearName(fullLast);
    
    const { firstLetter: FLNI, firstVocal: FLNV, firstConsonant: FLNC } = parseName(firstLastName);
